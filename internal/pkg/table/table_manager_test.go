...
func TestProcessBGPUpdate_1_select_high_localpref_ipv4(t *testing.T) {
	...
	nexthop1 := bgp.ParsePathAttributeNextHop("192.168.50.1")
	...
	nlri1 := []*bgp.IPAddrPrefix{bgp.ParseIPAddrPrefix(24, "10.10.10.0")}
	...
	nexthop2 := bgp.ParsePathAttributeNextHop("192.168.50.1")
	...
	nlri2 := []*bgp.IPAddrPrefix{bgp.ParseIPAddrPrefix(24, "10.10.10.0")}
...
func TestProcessBGPUpdate_1_select_high_localpref_ipv6(t *testing.T) {
	...
	mp_reach1 := createMpReach("2001::192:168:50:1",
		[]bgp.AddrPrefixInterface{bgp.ParseIPv6AddrPrefix(64, "2001:123:123:1::")})
...
func TestProcessBGPUpdate_2_select_local_origin_ipv4(t *testing.T) {
	...
	nexthop2 := bgp.ParsePathAttributeNextHop("0.0.0.0")
	med2 := bgp.NewPathAttributeMultiExitDisc(100)
...
func TestProcessBGPUpdate_4_select_low_origin_ipv4(t *testing.T) {
	...
	origin2 := bgp.NewPathAttributeOrigin(0)
	aspath2 := createAsPathAttribute([]uint32{65100, 65000})
	nexthop2 := bgp.ParsePathAttributeNextHop("192.168.100.1")
	med2 := bgp.NewPathAttributeMultiExitDisc(100)
	localpref2 := bgp.NewPathAttributeLocalPref(100)
...
func TestProcessBGPUpdate_8_withdraw_path_ipv4(t *testing.T) {
	...
	//withdraw path
	w1 := bgp.ParseIPAddrPrefix(24, "10.10.10.0")
...
func TestProcessBGPUpdate_multiple_nlri_ipv4(t *testing.T) {
	...
	createPathAttr := func(aspaths []uint32, nh string) []bgp.PathAttributeInterface {
		...
		nexthop := bgp.ParsePathAttributeNextHop(nh)
	...
	nlri1 := []*bgp.IPAddrPrefix{
		bgp.ParseIPAddrPrefix(24, "10.10.10.0"),
		bgp.ParseIPAddrPrefix(24, "20.20.20.0"),
		bgp.ParseIPAddrPrefix(24, "30.30.30.0"),
		bgp.ParseIPAddrPrefix(24, "40.40.40.0"),
		bgp.ParseIPAddrPrefix(24, "50.50.50.0")}
	bgpMessage1 := bgp.NewBGPUpdateMessage(nil, pathAttributes1, nlri1)

	// path2
	pathAttributes2 := createPathAttr([]uint32{65000, 65100, 65300}, "192.168.50.1")
	nlri2 := []*bgp.IPAddrPrefix{
		bgp.ParseIPAddrPrefix(24, "11.11.11.0"),
		bgp.ParseIPAddrPrefix(24, "22.22.22.0"),
		bgp.ParseIPAddrPrefix(24, "33.33.33.0"),
		bgp.ParseIPAddrPrefix(24, "44.44.44.0"),
		bgp.ParseIPAddrPrefix(24, "55.55.55.0")}
	bgpMessage2 := bgp.NewBGPUpdateMessage(nil, pathAttributes2, nlri2)

	// path3
	pathAttributes3 := createPathAttr([]uint32{65000, 65100, 65400}, "192.168.50.1")
	nlri3 := []*bgp.IPAddrPrefix{
		bgp.ParseIPAddrPrefix(24, "77.77.77.0"),
		bgp.ParseIPAddrPrefix(24, "88.88.88.0"),
	}
	...
	nlri4 := []*bgp.IPAddrPrefix{
		bgp.ParseIPAddrPrefix(24, "99.99.99.0"),
	}
...
func TestProcessBGPUpdate_multiple_nlri_ipv6(t *testing.T) {
	...
	mpreach1 := createMpReach("2001::192:168:50:1", []bgp.AddrPrefixInterface{
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1210:11::"),
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1220:11::"),
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1230:11::"),
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1240:11::"),
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1250:11::"),
	})
	...
	mpreach2 := createMpReach("2001::192:168:50:1", []bgp.AddrPrefixInterface{
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1211:11::"),
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1222:11::"),
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1233:11::"),
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1244:11::"),
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1255:11::"),
	})
	...
	mpreach3 := createMpReach("2001::192:168:50:1", []bgp.AddrPrefixInterface{
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1277:11::"),
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1288:11::"),
	})
	...
	mpreach4 := createMpReach("2001::192:168:50:1", []bgp.AddrPrefixInterface{
		bgp.ParseIPv6AddrPrefix(64, "2001:123:1299:11::"),
	})
...
func update_fromR1_ipv6() *bgp.BGPMessage {
	...
	mp_nlri := []bgp.AddrPrefixInterface{bgp.ParseIPv6AddrPrefix(64, "2001:123:123:1::")}
	mp_reach := bgp.ParsePathAttributeMpReachNLRI("2001::192:168:50:1", mp_nlri)
	med := bgp.NewPathAttributeMultiExitDisc(0)
...
func update_fromR2_ipv6() *bgp.BGPMessage {
	...
	mp_reach := createMpReach("2001::192:168:100:1",
		[]bgp.AddrPrefixInterface{bgp.ParseIPv6AddrPrefix(64, "2002:223:123:1::")})
	med := bgp.NewPathAttributeMultiExitDisc(100)
...
func createMpReach(nexthop string, prefix []bgp.AddrPrefixInterface) *bgp.PathAttributeMpReachNLRI {
	mp_reach := bgp.ParsePathAttributeMpReachNLRI(nexthop, prefix)
	return mp_reach
}

func createMpUNReach(nlri string, len uint8) *bgp.PathAttributeMpUnreachNLRI {
	mp_nlri := []bgp.AddrPrefixInterface{bgp.ParseIPv6AddrPrefix(len, nlri)}
